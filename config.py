...
EXERCISE_TEXT_START = """<b>СЛУЧАЙНОЕ ЗАДАНИЕ ИЗ 1 ЧАСТИ🎲</b>
Задание №%s: %s

<i>Напиши свой ответ или напиши /stop:</i>"""
EXERCISE_TEXT_SUCCESS = """<i>Правильный ответ!</i> ✅"""
EXERCISE_TEXT_FAIL = """<i>Неправильный ответ, попробуй ещё раз</i> ❌"""
EXERCISE_TEXT_STOP = """<i>Правильным ответом был:</i> %s"""
